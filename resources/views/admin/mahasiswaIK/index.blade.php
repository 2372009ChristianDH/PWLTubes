...
@section('content')
    ...
    <div class="card-header">
        <div class="d-flex align-items-center">
            <a href="{{ route('mahasiswa.createMahasiswaIK') }}" class="btn btn-primary btn-round ms-auto" style="margin-right: 100px; font-size: 17px;">
                ...
                <table id="table-keaktifan" class="table table-bordered table-hover table-striped"
                    ...
                    @foreach ($dataMahasiswa as $data)
                        <tr>
                            ...
                            <td>
                            <!-- Tombol Edit -->
                            <a href="{{ route('mahasiswa.editMahasiswaIK', ['id' => $data->user->id]) }}" class="btn btn-warning btn-sm">
                                <i class="fa fa-edit"></i> Edit
                            </a>

                            <!-- Tombol Hapus -->
                            <form action="{{ route('mahasiswa.deleteMahasiswaIK', ['id' => $data->user->id] ) }}" method="POST" style="display:inline;" 
