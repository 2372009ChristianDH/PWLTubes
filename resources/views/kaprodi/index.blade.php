                    ...
                    <tbody>
                        @foreach ($suratKeaktifan as $item)
                            <tr>
                                ...
                                <td>{{ $item->suratDetail->status_persetujuan }}</td>
                                <td>
                                    @if ($item->suratDetail->status_persetujuan == 'pending')
                                        <form action="{{ route('surat.acc', $item->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="submit" class="btn btn-success btn-sm">Terima</button>
                                        </form>
                                        <form action="{{ route('surat.tolak', $item->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="submit" class="btn btn-danger btn-sm">Tolak</button>
                                        </form>
                                    @else
                                        <span class="badge bg-{{ $item->suratDetail->status_persetujuan == 'Disetujui' ? 'success' : 'danger' }}">
                                            {{ $item->suratDetail->status_persetujuan }}
                                        </span>
                                    @endif
                                </td>
