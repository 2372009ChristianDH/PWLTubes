        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="table-keaktifan" class="table table-bordered table-hover align-middle" style="width: 100%;">
                        ...
                        <tbody>
                            @php
                                $filteredKeaktifan = $suratKeaktifan->filter(function ($item) {
                                    return in_array($item->suratDetail->status_persetujuan, ['Sedang Diproses Tata Usaha', 'Menunggu Persetujuan Kaprodi']);
                                });
                                $no = 1;
                            @endphp
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->suratDetail->status_persetujuan == 'Menunggu Persetujuan Kaprodi')
                                            <span class="text-warning">📋 {{ $item->suratDetail->status_persetujuan }}</span>
                                        @elseif ($item->suratDetail->status_persetujuan == 'Sedang Diproses Tata Usaha')
                                            <span class="text-primary">🛠️ {{ $item->suratDetail->status_persetujuan }}</span>
                                        @elseif ($item->suratDetail->status_persetujuan == 'Disetujui')
                                            <span class="text-success">✅ {{ $item->suratDetail->status_persetujuan }}</span>
                                        @elseif ($item->suratDetail->status_persetujuan == 'Surat Ditolak')
                                            <span class="text-danger">❌ {{ $item->suratDetail->status_persetujuan }}</span>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-info btn-sm d-flex align-items-center mx-auto"
                                            data-bs-toggle="modal" data-bs-target="#modalKeaktifan{{ $item->id }}">
                                    ...
                                    <div class="modal fade" id="modalKeaktifan{{ $item->id }}" tabindex="-1"
                                        aria-labelledby="modalKeaktifanLabel{{ $item->id }}" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modalKeaktifanLabel{{ $item->id }}">Detail Surat</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    @elseif ($item->suratDetail->status_persetujuan == 'Disetujui')
                                                        ...
                                                        <a href="{{ url('lihat-surat/' . $item->suratDetail->file_surat) }}"
                                                            target="_blank" class="btn btn-primary btn-sm">Lihat Surat</a>
                                                    @endif
                                                </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted">Belum ada data surat keaktifan.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
...
<div class="tab-pane fade" id="lhs" role="tabpanel" aria-labelledby="lhs-tab">
    <div class="container-fluid px-5 py-4">
        <div class="card shadow-sm">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="table-laporan-hasil-studi" class="table table-bordered table-hover align-middle" style="width: 100%;">
                        <thead class="table-primary text-center">
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
                        ...
                        <tbody>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    @elseif ($item->suratDetail->status_persetujuan == 'Disetujui')
                                                        <p><strong>Keterangan:</strong> {{ $item->suratDetail->keterangan }}</p>
                                                        <a href="{{ url('lihat-surat/' . $item->suratDetail->file_surat) }}" target="_blank" class="btn btn-primary btn-sm">Lihat Surat</a>
                                                    @endif
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted">Belum ada data surat laporan hasil studi.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
...
<div class="tab-pane fade" id="ptmk" role="tabpanel" aria-labelledby="ptmk-tab">
    <div class="container-fluid px-5 py-4">
        <div class="card shadow-sm">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="table-pengantar-tugas" class="table table-bordered table-hover align-middle" style="width: 100%;">
                        <thead class="table-primary text-center">
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted">Belum ada data surat pengantar tugas mata kuliah.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
...
<div class="tab-pane fade" id="kelulusan" role="tabpanel" aria-labelledby="kelulusan-tab">
    <div class="container-fluid px-5 py-4">
        <div class="card shadow-sm">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="table-kelulusan" class="table table-bordered table-hover align-middle" style="width: 100%;">
                        <thead class="table-primary text-center">
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted">Belum ada data surat kelulusan.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
